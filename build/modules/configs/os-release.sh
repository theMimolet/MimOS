...
echo "::group::Generating Custom OS-Release"

IMAGE_PRETTY_NAME="MimOS"
IMAGE_LIKE="fedora"
HOME_URL="https://themimolet.github.io"
DOCUMENTATION_URL=""
SUPPORT_URL=""
BUG_SUPPORT_URL="https://github.com/themimolet/mimos/issues/"
LOGO_ICON="mimolet-icon"
...
# Rebrand system-release so that grub2-mkconfig uses "MimOS" as the distributor
...
echo "::endgroup:: === Custom OS-Release generated ==="
